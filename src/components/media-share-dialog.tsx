    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose where and how to share this {mediaType}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="rounded-lg border overflow-hidden bg-muted/30">
          {mediaType === 'image' ? (
            ...
            <video src={mediaUrl} controls className="w-full aspect-video bg-black" />
          )}
        </div>
